...
public class Options implements Cloneable {
    ...
    public enum Tables {
         ...
         *
         * @see
         * <a href="http://michelf.com/projects/php-markdown/extra/#table">PHP Markdown Extra Tables</a>
         */
         ...
         *
         * @see
         * <a href="http://fletcher.github.com/peg-multimarkdown/#tables">MultiMarkdown Tables</a>
         */
        ...
        private Tables(boolean removed, boolean leftAsHtml, boolean convertedToText,
                       boolean renderedAsCode, boolean colspanEnabled) {
    ...
    public enum InWordEmphasis {
        ...
        NORMAL(true, false),
        /**
         * Adds spaces around the in-word emphasis characters.  This will actually render
         * different output.
         * <p>
         * For example, {@code My<em>Example</em>Word} becomes {@code My *Example* Word}.  This
         * will actually
         * render as {@code My <em>Example</em> Word}.
         */
        ADD_SPACES(true, true),
        /**
         * Removes in-word emphasis altogether.  Designed for parsers that do not allow in-word
         * asterisks
     ...
     * <p>If false, {@code <br/>}s are replaced with a two spaces followed by a linebreak
     * (default).</p>
     */
    ...
    /**
     * If true, place the URLs for links inline (the default).
     * <p>Otherwise, generate link IDs and place at the end.</p>
     */
    public boolean inlineLinks = true;
     ...
     * are converted into
     * <a href="http://michelf.com/projects/php-markdown/extra/#def-list">PHP Markdown Extra style definition lists</a>.
     */
     ...
     * into
     * <a href="http://michelf.com/projects/php-markdown/extra/#abbr">PHP Markdown Extra style abbreviations</a>.
     */
     ...
     * into
     * <a href="http://michelf.com/projects/php-markdown/extra/#header-id">PHP Markdown Extra style header IDs</a>.
     */
    public boolean headerIds = false;

    /**
     * Configures how to handle code blocks.  By default, code blocks are only configured
     * using the indented format supported by Markdown.  This allows fenced code blocks when
     * necessary.
     */
    @SuppressWarnings({"WeakerAccess"})
    ...
    /**
     * This is a very specific fix for a very specific bug.  As of version 1.0.2, pegdown has a
     * serious bug that
     * really slows down when processing many links with <strong>bold</strong> and
     * <em>italics</em> in the label for
     * an anchor.
     * <p>
     * This option causes Remark to replace items like {@code [***my important link***][link-id]}
     * with just
